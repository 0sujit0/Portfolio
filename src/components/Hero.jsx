...
export function Hero() {
  return (
    <section id="hero" className="min-h-[calc(100vh-60px)] flex flex-col justify-center section-padding pt-0 pb-0">
      <div className="text-xs font-medium tracking-[1.4px] uppercase text-terracotta mb-6">
        Product · Operations · Fintech
      </div>
      
      <h1 className="font-serif text-[clamp(40px,6vw,72px)] font-medium leading-[1.08] text-near-black mb-7 max-w-[720px]">
        Sujit Kumar Sahu
      </h1>
      
      <p className="font-serif text-[clamp(18px,2.4vw,26px)] font-normal leading-[1.40] text-charcoal-warm max-w-[600px] mb-4">
        Product-oriented operator at a payments bank. Moving into PM.
      </p>
      
      <p className="text-[17px] font-normal leading-[1.60] text-stone-gray max-w-[560px] mb-12">
